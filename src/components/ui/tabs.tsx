...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ...
    className={cn(
      ...
      "w-full min-w-max overflow-x-auto scrollbar-thin scrollbar-track-transparent scrollbar-thumb-gray-300",
      "gap-1 flex-nowrap",
...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.Trigger
    ...
    className={cn(
      ...
      "ring-offset-background transition-all flex-shrink-0 min-w-fit",
